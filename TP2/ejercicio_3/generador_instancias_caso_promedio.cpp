...
int main(int argc, char** argv)
{
    ...
    ofstream output("C:/Emanuel/Facu/Algo 3/Git/AlgoIII/TP2/ejercicio_3/InstanciasRandom.txt", ios::out);
    ...
    for(auto i = 0; i < instancias; i++)
    {
        ...
        falseAll(unidos);
        output << cantEquipos << ' ' << cantAristasPorInstancia << endl;

        for(auto j = 0; j < cantAristasPorInstancia; j++)
        {
