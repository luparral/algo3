...
\begin{enumerate}
\item \includegraphics[scale=0.75]{Grafo1}
\newline
\newline
\item \includegraphics[scale=0.75]{Grafo2}
\newline
\newline
\item \includegraphics[scale=0.75]{Grafo3}
\end{enumerate}
...
\includegraphics[scale=0.75]{Proceso}
...
\includegraphics[scale=0.60]{Grafico_Caso_Promedio}
...
\includegraphics[scale=0.60]{Grafico_Peor_Caso}
...
\includegraphics[scale=0.60]{Grafico_Caso_Sin_Aumento_Arista}
